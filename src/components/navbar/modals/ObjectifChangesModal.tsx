...
const ObjectifChangesModal: React.FC<ObjectifChangesModalProps> = ({
  ...
  // Filter only changes for the current month
  const currentMonthChanges = objectifChanges.filter(change => {
          ...
          <div className="max-h-[300px] overflow-y-auto pr-1">
            {currentMonthChanges.length > 0 ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-xs mt-1 opacity-60">Les statistiques se réinitialisent chaque 1er du mois</p>
              </div>
            )}
          </div>
        </div>
