...
const AppointmentDetails = ({
  ...
  return (
    <Dialog open={open} onOpenChange={(open) => {
      ...
      <DialogContent className="max-w-md backdrop-blur-xl bg-white/95 border-0 shadow-2xl overflow-hidden relative">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-xs text-gray-500">Rendez-vous premium</span>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-200/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Temps alloué</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-xl p-4 border border-emerald-200/50">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">Adresse du rendez-vous</p>
                </div>
              </div>
            </div>
