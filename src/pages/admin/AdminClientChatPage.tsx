              ...
              <div className="p-6 bg-gradient-to-r from-gray-50 to-white">
                <div className="flex space-x-4">
                  ...
                  <Button 
                    ...
                    disabled={!selectedSession || !newMessage.trim()}
                    className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white border-0 px-6 h-12 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
                  >
